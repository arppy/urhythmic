...
def encode_dataset(args):
    ...
    checkpoint_path = f"ljspeech_wavlm_kmeans_100.pt"
    torch.save({"n_features_in_": kmeans.n_features_in_, "_n_threads": kmeans._n_threads, "cluster_centers_": kmeans.cluster_centers_}, checkpoint_path)
